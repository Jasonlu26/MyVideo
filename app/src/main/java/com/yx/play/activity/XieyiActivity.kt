...
class XieyiActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        mBinding.tvContent.text = "\n" +
                " 1.信息收集\n" +
                "  \n" +
                " 我们收集的数据取决于您与我们互动的环境，您做出的选择（包括您的隐私设置）以及您使用的产品和功能。我们收集的数据可以包括SDK / API / JS代码版本，浏览器，Internet服务提供商，IP地址，平台，时间戳，应用程序标识符，应用程序版本，应用程序分发渠道，独立的设备标识符，Android广告主标识符，网卡（MAC）地址和国际移动设备识别码（IMEI）设备型号，终端制造商，终端设备操作系统版本，会话开始/停止时间，语言的位置，时区以及网络状态（WiFi等），硬盘，CPU和电池使用情况等。\n" +
                "   \n" +
                "  \n" +
                " 2.个人资料的使用\n" +
                "  \n" +
